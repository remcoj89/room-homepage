...
const AboutSection = () => {
  ...
  return (
    <div className="about-section">
      <img className='about-section--image' src="./images/about/image-about-dark.jpg" alt="Room Homepage" />
      ...
      <img className='about-section--image' src="./images/about/image-about-light.jpg" alt="Room Homepage" />
    </div>
  )
}
